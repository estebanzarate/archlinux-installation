...
```bash
sudo pacman -S base-devel bat binutils firefox git hashcat hydra john kitty neovim openbsd-netcat openvpn perl-image-exiftool polybar rust unzip virtualbox-guest-utils xclip xorg-xset
```
